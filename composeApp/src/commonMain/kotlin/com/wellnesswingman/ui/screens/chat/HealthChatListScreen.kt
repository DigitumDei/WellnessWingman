...
class HealthChatListScreen : Screen {
    ...
    override fun Content() {
        ...
        // Re-runs when this screen returns to the top. The screen model outlives a trip into a
        // thread, so a conversation started there would otherwise be missing from the list
